...
public class RegistrationSpec {
    ...
    public static final ResponseSpecification badRequestResponseSpec =
            new ResponseSpecBuilder().log(ALL).expectStatusCode(400).build();

    public static final ResponseSpecification methodNotAllowedResponseSpec = new ResponseSpecBuilder()
            .log(ALL)
            .expectStatusCode(405)
            .expectHeader("Allow", containsString("POST"))
            .build();

    public static final ResponseSpecification unsupportedMediaTypeResponseSpec =
