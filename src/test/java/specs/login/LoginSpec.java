...
public class LoginSpec {
    ...
    public static final ResponseSpecification validationErrorResponseSpec =
            new ResponseSpecBuilder().log(ALL).expectStatusCode(400).build();

    public static final ResponseSpecification methodNotAllowResponseSpec = new ResponseSpecBuilder()
            .log(ALL)
